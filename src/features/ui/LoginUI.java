...
public class LoginUI extends JPanel {
    ...
    public LoginUI(E_Report app) {
        ...
        ImageIcon logo = new ImageIcon(new ImageIcon(UIConfig.LOGO_PATH).getImage().getScaledInstance(60, 60, Image.SCALE_SMOOTH));
        ...
        gbc.gridy = 1; gbc.insets = new Insets(10, 40, 5, 40);
        ...
        gbc.gridy = 2; gbc.insets = new Insets(5, 40, 18, 40);
        ...
        gbc.gridy = 5; gbc.insets = new Insets(0, 40, 25, 40);
        ...
        gbc.gridy = 6; gbc.insets = new Insets(10, 40, 0, 40);
